...
async function DBInit() {
  ...
  const resfolderall = await conn.query('CREATE TABLE IF NOT EXISTS folders_all(ID BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, name varchar(255) not null, statusID INT, CONSTRAINT fk_status_folder_all FOREIGN KEY (statusID) REFERENCES status_folder(ID));');
